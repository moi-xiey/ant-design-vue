    ...
    <v-card :bordered="false">
      <result :is-success="true" :description="description" :title="title">
        <template slot="action">
          <v-button type="primary">返回列表</v-button>
          <v-button style="margin-left: 8px">查看项目</v-button>
          <v-button style="margin-left: 8px">打印</v-button>
        </template>
        <div>
          <div style="font-size: 16px; color: rgba(0, 0, 0, 0.85); font-weight: 500; margin-bottom: 20px;">项目名称</div>
          <v-row style="margin-bottom: 16px">
            <v-col :xs="24" :sm="12" :md="12" :lg="12" :xl="6">
            ...
            <v-col :xs="24" :sm="24" :md="24" :lg="24" :xl="12">
              <span style="color: rgba(0, 0, 0, 0.85)">生效时间：</span>
              2016-12-12 ~ 2017-12-12
            </v-col>
          </v-row>
          <v-steps :current="1" :direction="isMobile() && directionType.vertical || directionType.horizontal" progressDot>
            <v-step>
              ...
              <template slot="description">
                <div style="fontSize: 12px; color: rgba(0, 0, 0, 0.45); position: relative; left: 42px;" slot="description">
                  <div style="margin: 8px 0 4px">
                    曲丽丽
                    <v-icon style="margin-left: 8px" type="dingding-o"/>
                  </div>
            ...
            <v-step title="部门初审">
              ...
              <template slot="description">
                <div style="fontSize: 12px; color: rgba(0, 0, 0, 0.45); position: relative; left: 42px;" slot="description">
                  <div style="margin: 8px 0 4px">
                    周毛毛
                    <v-icon style="margin-left: 8px; color: #00A0E9" type="dingding-o"/>
                  </div>
